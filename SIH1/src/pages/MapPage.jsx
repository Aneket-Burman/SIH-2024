        ...
        <div className="absolute z-20 cursor-move top-16 left-4">
          <Card className="w-80 border border-transparent dark:bg-black dark:border-white/[0.2] bg-white/[0.7] p-4 rounded-2xl shadow-lg">
            ...
            <CardContent>
              ...
              {/* Go Button */}
              <Button className="flex justify-end p-5 mt-5 rounded-xl" onClick={handleSave}>
                Go
              </Button>
            </CardContent>

            <div className="flex justify-center">_______________________________</div>
            <CardFooter className="flex justify-center space-between">
